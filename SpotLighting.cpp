...
HRESULT SpotLighting::Init( void )
{
	...
	//シェーダー読み込み
	CreateVertexShader( &m_VertexShader, &m_VertexLayout, "SpotLightingVS.cso" );
	CreatePixelShader( &m_PixelShader, "SpotLightingPS.cso" );
...
void SpotLighting::Update( void )
{
	...
	//ImGui::Begin( "SpotLightingmodel" );
	//{
	//	ImGui::SliderFloat( "PonintLightParam.x", &m_Light.PointLightParam.x, 0.5f, 5.0f, "％,2f" );

	//	ImGui::SliderFloat( "PonintLightParam.y", &m_Light.PointLightParam.y, 1.0f, 5.0f, "％,2f" );
