...
// ‰Šú‰»ˆ—
//=============================================================================
HRESULT Gaussian::Init( void )
{
	CreateVertexShader( &m_VertexShader, &m_VertexLayout, "GaussianVS.cso" );
	CreatePixelShader( &m_PixelShader, "GaussianPS.cso" );
	...
	m_Rotate = 0.0f;
	m_Parameter = XMFLOAT4( SCREEN_WIDTH, SCREEN_HEIGHT, 1.0f, 0.25f );
...
void Gaussian::Update( void )
{
	ImGui::Begin( "Mozaic" );
	{
		ImGui::SliderFloat( "Size", &m_Parameter.z, 1.0f, 64.0f, "%0.0f" );
		ImGui::SliderFloat( "Radius", &m_Parameter.w, 0.0f, 1.0f, "%.2f" );
	}
	ImGui::End();
}
