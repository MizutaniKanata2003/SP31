...
{
	//シェーダー読み込み
	CreateVertexShader( &m_VertexShader, &m_VertexLayout, "HemiSphereLightingVS.cso" );
	CreatePixelShader( &m_PixelShader, "HemiSphereLightingPS.cso" );
	...
	m_Light.Ambient = XMFLOAT4( 0.1f, 0.1f, 0.1f, 1.0f ); // 環境光
