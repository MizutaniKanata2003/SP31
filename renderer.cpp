...
HRESULT InitRenderer( HINSTANCE hInstance, HWND hWnd, BOOL bWindow )
{
	...
	hr = D3D11CreateDeviceAndSwapChain( NULL, D3D_DRIVER_TYPE_HARDWARE, NULL, 0, NULL, 0, D3D11_SDK_VERSION, &sd, &g_SwapChain, &g_D3DDevice, &g_FeatureLevel, &g_ImmediateContext );
...

	{
		...
		srvd.Texture2D.MipLevels = -1;//ミップマップ使う
...
void CreateVertexShader( ID3D11VertexShader** VertexShader, ID3D11InputLayout** VertexLayout, const char* FileName )
{
	...
	g_D3DDevice->CreateInputLayout( layout, numElements, buffer, fsize, VertexLayout );
