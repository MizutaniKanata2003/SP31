...
{
	//シェーダー読み込み
	CreateVertexShader( &m_VertexShader, &m_VertexLayout, "PixelLightingBlinnPhongVS.cso" );
	CreatePixelShader( &m_PixelShader, "PixelLightingBlinnPhongPS.cso" );

	//3Dオブジェクト管理構造体の初期化
	m_Position = XMFLOAT3( 0.0f + 0.5f * 3, 0.2f, 0.0f );
